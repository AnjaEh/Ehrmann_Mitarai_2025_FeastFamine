...
@author: Anja Ehrmann
Feast Famine Model for Ehrmann & Mitarai (2026). Generates plots for Supplementary Figure S10 (A, B, C). Testing constant alpha . 
...
pars['p_deg'] = 0 
pars['fresh_bacteria'] = 0.045*pars['S_1']
pars['dilution'] = 0.1
...
plt.ylim(-0.6, 0.4)
plt.title(r"Feast-Famine with fixed $\alpha = 0.045$")
