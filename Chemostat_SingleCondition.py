"""Chemostat model for paper Ehrmann & Mitarai (2026). Generates plot 2A"
...
plt.savefig(f"Plots/{today}_Chemostat_SingleCondition_Flow{pars['flow_rate']:.3g}_Delay{pars['gamma_delay']:.3g}_Burst{pars['burst_T7_low']:.3g}.svg", format = 'svg', dpi=600, bbox_inches='tight')
plt.show()
