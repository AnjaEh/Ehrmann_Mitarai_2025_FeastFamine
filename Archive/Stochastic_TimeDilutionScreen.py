...
def system_of_equations(t, y, pars):
    ...
    #Ensuring non-negativity of all variables is necessary to ensure solver stability for some of the more extreme conditions
...
def simulation(initial_conditions, pars):  
    ...
    return [t_final, phage_T4_final, phage_T7_final, bacteria_final, infected_T4_final,
            infected_T7_final, substrate_final, alpha_values, phage_T4_trend, phage_T7_trend]
...
result_competitive_burst_value = np.empty_like(list_parameter_3)

for k in list_parameter_2:
    pars['time_span'] = k

    result_competitive_burst_par_k = np.array([])
    result_competitive_burst_par_k_value = np.array([])
    ...
    for m in list_parameter_3:
        ...
        for j in list_parameter_1:
            ...
            for i in range(0,100):
                ...
                t_final, phage_T4_final, phage_T7_final, bacteria_final, infected_T4_final, infected_T7_final, \
                    substrate_final, alpha_values, phage_T4_trend, phage_T7_trend = output
        ...
        result_competitive_burst_par_k_value = np.append(result_competitive_burst_par_k_value, list_parameter_1[final_negative_index])
    ...
    result_competitive_burst_value = np.vstack((result_competitive_burst_value, result_competitive_burst_par_k_value))

# Add list_parameter_2 and list_parameter_3 as row to result_competitive_burst
result_competitive_burst = np.vstack((list_parameter_3, result_competitive_burst[1:]))
result_competitive_burst_value = np.vstack((list_parameter_3, result_competitive_burst_value[1:]))
