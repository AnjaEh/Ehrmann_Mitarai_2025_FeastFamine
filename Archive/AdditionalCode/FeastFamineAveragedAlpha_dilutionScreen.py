...
@author: Anja Ehrmann
Feast Famine Model for Ehrmann & Mitarai (2025). Generates plots for Supplementary Figure 8. Testing contant alpha with different dilution factors. 
...
def system_of_equations(t, y, pars):
    ...
    #deg_bacteria = pars['deg_bacteria']
    p_deg = pars['p_deg']
...
def simulation(initial_conditions, pars):
    ...
    return [t_final, phage_T4_final, phage_T7_final, bacteria_final, infected_T4_final,
            infected_T7_final, bacteria_sum_final, substrate_final, starvation_time, phage_T4_trend, phage_T7_trend]
...
list_parameter_3 = np.logspace(-3, -0.02, num = 12)
...
for j in list_parameter_2:
    ...
    for i in list_parameter_3:
        ...
        t_final, phage_T4_final, phage_T7_final, bacteria_final, infected_T4_final, infected_T7_final, \
            bacteria_sum_final, substrate_final, starvation_time, phage_T4_trend, phage_T7_trend = output
...
start_idx = 4
end_idx = len(list_parameter_3) - 2
...
plt.tight_layout()
#plt.savefig('Plots/DilutionFactor_fixedAlpha.svg', format = 'svg',  dpi=600, bbox_inches='tight')
plt.show()
